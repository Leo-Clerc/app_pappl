...
const ChampAge = ({bonAge, age, changeAge, changeAgeOk}) =>{
    return  <View>
    <TextInput style = {styles.input} value = {age.toString()} onChangeText = {(value) => {changeAge(parseInt(value,10)); changeAgeOk(parseInt(value,10) === bonAge)}}  keyboardType="numeric"  />
    <Slider
        value= {age}
